...
CREATE TABLE [TopShowsAndGenres]
(
    [ID]                    INT                 NOT NULL PRIMARY KEY IDENTITY(1,1),
    [UserID]                INT                 NOT NULL,
    [Show1]                 NVARCHAR(32),
...
ALTER TABLE [TopShowsAndGenres]     ADD CONSTRAINT [Fk_TopShowsAndGenres_UserID]    FOREIGN KEY([UserID])                   REFERENCES[Watcher]([Id])           ON DELETE NO ACTION ON UPDATE NO ACTION;